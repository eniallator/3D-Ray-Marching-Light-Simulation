...
function love.load()
    ...
    local glow = RayMarcher.Material({glowStrength = 1, glowRange = 5, glowColour = {1, 1, 0.3}})
    scene:registerMaterial(glow)

    local sphere = RayMarcher.Object({type = 'sphere', material = glow, position = {0, 25, 0}, data = {radius = 5}})
