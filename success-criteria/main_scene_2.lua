...
function love.load()
    ...
    local transparent = RayMarcher.Material({transparency = 1, speedOfLight = 250})
    scene:registerMaterial(transparent)

    local sphere =
        RayMarcher.Object({type = 'sphere', material = transparent, position = {0, 25, 0}, data = {radius = 5}})
